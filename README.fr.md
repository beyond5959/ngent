...
- 🖥️ **UI intégrée** : aucun déploiement frontend séparé n'est nécessaire, l'interface web est embarquée dans le binaire
- 🌏 **UI localisée** : l'interface web intégrée prend en charge English, 简体中文, Español et Français
