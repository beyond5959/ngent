...
func TestSupportedAgentsOnlyIncludesAvailableAgents(t *testing.T) {
	...
	agentsSubset := supportedAgents(true, false, false, false, true, false, false, false, false, false)
	...
	for i, wantID := range []string{"codex", "pi", "claude", "gemini", "kimi", "qwen", "opencode", "blackbox", "cursor", "goose"} {
